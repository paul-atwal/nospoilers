...
export const formatKickoff = (kickoffAt: string | null, timeZone?: string): KickoffView => {
  ...
  const parts = new Intl.DateTimeFormat(undefined, { ...options, hour: 'numeric', minute: '2-digit', timeZoneName: 'short' }).formatToParts(date);
