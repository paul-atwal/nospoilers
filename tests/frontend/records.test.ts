...
import { formatTeamRecord, parseTeamRecord } from '../../utils/records';
...
describe('record display formatting', () => {
  ...
  it('parses only valid provider record strings', () => {
    expect(parseTeamRecord('8-2-1')).toEqual({ wins: 8, losses: 2, ties: 1 });
